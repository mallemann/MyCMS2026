...
public class TodoEditModel : PageModel
{
    ...
    public TodoEditModel(TodoService todos, UserService users, ProjectService projects, NavigationService nav, WeeklyMailService weeklyMail)
    {
        _todos      = todos;
        _users      = users;
        _projects   = projects;
    ...
    public async Task<IActionResult> OnPostAsync()
    {
        ...
        if (string.IsNullOrEmpty(Todo.Id) && string.IsNullOrWhiteSpace(Todo.Gruppe))
        {
